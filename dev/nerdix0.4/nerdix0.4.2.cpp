/*Finalmente consegui simplificar a alternância entre jogadores;
 * POREM;
 * condição VELHA não tá mais verificando direito.
 * jogar_robo ficou IMPRESTÁVEL... já dá para pensar em re-escrever ela.
 * ainda tem mudanças importantes a partir de agora na logica principal
 * do jogo_da_velha, chamar jogar_humano, chamar jogar_robo.
 * (no sentido de otimizar e simplificar)
 * */
#include <iostream>
#include <cstdlib>
...
//Será inicializada em main() o game "nerd" (apenas uma que será usado sempre).
	...
	void jogar_humano(player*, game*); //jogada do player humano.
	void jogar_robo(player*, game*); //jogada do player robô.
