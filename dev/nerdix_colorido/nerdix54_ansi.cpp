...
int main(){
	...
	intro();
	mostrar_rank();
	cout << "\nBem vindo ao \033[1;31mNERDIX\033[0m, o jogo-da-velha mais nerd do mundo!\n";
	definir_jogadores(&X, &O);
	cout << "Vamos brincar um pouquinho?\n";
	jogo_da_velha(&X, &O, &nerd);
	replay(&X, &O, &nerd);
	gravar_rank(X, O, nerd);
	cout << "\n\033[1;31mTCHAU!\033[0m\n :-)";
	cout << "***Software desenvolvido por: barbolux && hugotones && reymc\n";
	cout << "***Versão 0.5.4 beta \n";
	cout << "***Atualizado: 04/04/2017 \n";
	cout << "\nVolte sempre para incrementar seus \033[1;31m\033[1;31mRECORDES\033[0m\033[0m! :-)";
	return 0;
}
...
if(p->human==true){
	...
	cout << "Vez de \033[1;34m" << p->name <<"\033[0m("<<p->simbolo<<") jogar. \033[1;34m" << p->round <<"\033[0mo Turno."<<endl;
	teclado(p, nerd);
	p->round++;
	nerd->turno++;
	nerd->roda++;
...
if ((verificar_ganhador(nerd)==false) && (nerd->turno > 9)){
	cout << "\033[1;33mA VELHA ganhou\033[0m :-P\n";
	nerd->velha++;
}
}
...
void imprimir(game *nerd){
	cout << ".Rodadas no total: \033[1;33m" << nerd->roda <<"\033[0m"<< endl;
	cout << ".Rodada nesta partida: \033[1;33m" << nerd->turno <<"\033[0m"<< endl;
...
cout << "	|\033[1;31mNERDIX\033[0m |0.5|     04|\n";
cout << "	|\033[1;34mE\033[0m      |   |  abril|\n";
